...
# String data type
restaurant_name = "Chainicorn"
owner_name = "Carmen Salonga"
...
# List data type
product_names = ["Pre-Made Bracelets", "DIY Bracelet Kits", "Caesar Salad"]
...
menu = {
    "Pre-Made Bracelets": 79.99,
    "DIY Bracelet Kits": 150.00,
    "Garlic Bread": 50.00,
    "Iced Tea": 30.00,
